...
namespace Underground_Adventures
{
    public class Goblin : Monster
    {
        ...
        public Goblin(int posX, int posY) : base(posX, posY)
        {
            image = Properties.Resources.GoblinL;
            flip = false;
            Health = 7;
            Damage = 1;
        ...
        public override void Draw(Graphics g)
        {
            ...
            if (currentFrame == 0)
            {
                if (flip) image = Properties.Resources.GoblinR;
                else image = Properties.Resources.GoblinL;
                currentFrame++;
            }
            else if (currentFrame == 2)
            {
                if (flip) image = Properties.Resources.GoblinR1;
                else image = Properties.Resources.GoblinL1;
                currentFrame++;
            }
            ...
            {
                if (flip) image = Properties.Resources.GoblinR2;
                else image = Properties.Resources.GoblinL2;
                currentFrame = -2;
            }
            else currentFrame++;
        ...
        public override void TakeDamage(Player player)
        {
            ...
            if (CurrentHealth > 0)
            {
                if (flip) image = Properties.Resources.GoblinRD;
                else image = Properties.Resources.GoblinLD;
                currentFrame = -6;
            }
        ...
        public override void Move(Player player)
        {
            ...
            {
                if (coin.posX == PosX && coin.PosY == PosY)
                {
            ...
            {
                image = Properties.Resources.GoblinR;
                flip = true;
            }
        }
    }
